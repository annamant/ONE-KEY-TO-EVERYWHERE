  ...
  return (
    <div className="page-content max-w-2xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <Badge color="purple" size="md">Owner Member</Badge>
      </div>
      ...
      <Card className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-caption text-text-muted mt-1">
            Club member since {formatDate(currentUser.createdAt)}
          </p>
        </div>
      </Card>
      ...
      <Card className="mb-6">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <FormField label="Phone number" htmlFor="phone" hint="Optional — used for Club communications">
            <Input
              id="phone"
              type="tel"
              value={phone}
      ...
      <Card>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-body-sm font-medium text-text-primary">Membership status</p>
              <p className="text-caption text-text-muted">Your Club membership is active</p>
            </div>
