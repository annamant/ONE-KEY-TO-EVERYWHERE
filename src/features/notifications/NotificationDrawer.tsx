...
const typeIcon: Record<NotificationType, React.ElementType> = {
  ...
  keys_credited: SparklesIcon,
  keys_debited: SparklesIcon,
  membership_credited: SparklesIcon,
  membership_debited: SparklesIcon,
  household_invite: UserGroupIcon,
  property_approved: HomeIcon,
  property_rejected: HomeIcon,
  payout_processed: SparklesIcon,
...
const typeColor: Record<NotificationType, string> = {
  ...
  membership_credited: 'bg-success-light text-success',
  membership_debited: 'bg-okte-gold-50 text-okte-gold-600',
